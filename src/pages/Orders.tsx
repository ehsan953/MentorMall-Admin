  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <h1 className="font-NotoSerif text-4xl font-bold">Orders</h1>
        <Button customClass="mt-6 border border-green-500 text-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600">
          Archived
        </Button>
      </div>
